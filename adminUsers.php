					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								...
								<span class="partbox-header-title-text">KULLANICILAR</span>
							</div>
						...
						<div id="" class="row">
							...
							<div id="" class="col-md-12 form-group-container-body">
								<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">KULLANICI LİSTESİ</span>
															</div>
									...
									<!-- form group end -->
									<!-- templateUserDetails handlebars template start -->
									<script id="templateUserDetails" type="text/x-handlebars-template">
											...
											<div class="row">
												...
												<ul class="nav nav-tabs tab-navigation-container">
													<li class="tab-navigation active">
														<a class="tab-navigation-link" data-toggle="tab" href="#tabUserProfileInformations">
															<span class="tab-navigation-text">PROFİL BİLGİLERİ</span>
														</a>
													</li>
													<li class="tab-navigation">
														<a class="tab-navigation-link" data-toggle="tab" href="#tabUserCoursePast">
															<i class=" tab-navigation-icon"></i>
															<span class="tab-navigation-text">EĞİTİM GEÇMİŞİ</span>
														</a>
													</li>
												</ul>
												<div class="tab-content">
													<div id="tabUserProfileInformations" class="tab-pane fade in active">
														<!-- form group container start -->
														<div id="" class="col-md-12 form-group-container">
															<div id="" class="row">
																			...
																			<div id="" class="row">
																				...
																				<div id="" class="col-md-12 form-group-header">
																					<div id="" class="row">
																						...
																						<div id="" class="col-md-3 form-group-header-controls">
																							<a href="" title="" target="_self" id="btnEditUser" class="btn btn-default " type="button">
																								...
																								<div id="" class="row">
																									...
																									<div id="" class="col-md-12 form-group-body">
																										<div id="" class="row">
																											...
																											<!-- form item end -->
																											<!-- form item start -->
																											<div id="CourseCountSuccess" class="col-md-12 form-item">
																												<div id="" class="row">
																											...
																											<div id="UserGroup" class="col-md-12 form-item">
																												<div id="" class="row">
																													...
																													<div id="" class="col-md-4 form-item-informations">
																														<div for="" class="form-item-title">KULLANICI GRUBU</div>
																														<div id="" class="form-item-description"></div>
																													</div>
																													<div id="" class="col-md-8 form-item-inputs">
																														{{UserGroup}}
																											...
																											<!-- form item end -->
																											<!-- form item start -->
																											<div id="LastLoginDate" class="col-md-12 form-item">
																												<div id="" class="row">

																													<div id="" class="col-md-4 form-item-informations">
																														<div for="" class="form-item-title">SİSTEME EN SON GİRİŞ TARİHİ</div>
																														<div id="" class="form-item-description"></div>
																													</div>
																													<div id="" class="col-md-8 form-item-inputs">
																														{{HelperDate LastLoginDate}}
																													</div>
													...
													<div id="tabUserCoursePast" class="tab-pane fade ">
														<!-- form group container start -->
														<div id="" class="col-md-12 form-group-container">
															<div id="" class="row">
									...
									<!-- templateUserDetails handlebars template end -->
									<!-- renderUserDetails handlebars render start -->
									<div id="renderUserDetails" class="render-template"></div>
									<!-- renderUserDetails handlebars render end -->
		...
		var table = $('#tableUsers').DataTable({
			...
			buttons: [
				...
				},
				{
					...
					titleAttr: 'Seçilen kullanıcılara eğitim talebi gönder',
					action: function(){
						$('#modalCourseRequest').modal('show');
					}
				},
				{
					text: '<i class="fa fa-ban btn-icon"></i>',
					className: 'btn-default',
					titleAttr: 'Seçilen kullanıcıları pasif hale getir',
					action: function(){
				...
				},
				{
					...
					className: 'btn-default',
					titleAttr: 'Seçilen kullanıcıları aktif hale getir',
					action: function(){
	...
	function DataTablesUserCoursePast(data){
		var table = $('#tableCoursePast').DataTable({
			...
			buttons: [
				...
				{
					text: '<i class="fa fa-trash btn-icon"></i>',
					className: 'btn-default btn-deleteCourses',
					titleAttr: 'Seçilenleri sil',
					action: function(){
	...
	$(document).ready(function(){
		...
		*/
		$('body').on('click', '#tableUsers tbody tr td:not(.column-select)', function(e){
			...
			// Rendering Template
			$('#renderUserDetails').Handle({
				source: $('#templateUserDetails'),
				data: data,
				append: false,
				prepend: false,
				callback: function(){
